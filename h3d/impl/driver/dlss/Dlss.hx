...
#if (limen && gfx_dx12 && dlss_allowed)

typedef DX12Device = limen.graphics.d3d12.internal.D3D12Bindings.Device;
typedef DX12Adapter = limen.graphics.d3d12.internal.D3D12Bindings.Adapter;
typedef DLSSRes = limen.graphics.d3d12.resource.Resources.Dx12Resource;
typedef DLSSResourceState = limen.graphics.d3d12.resource.Resources.ResourceState;
typedef DLSSCommandList = limen.graphics.d3d12.command.Commands.CommandList;
